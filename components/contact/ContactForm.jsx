...
const CommonContact = ({ condition }) => {
  ...
  const publicKey = 'user_0mZQDcLrpuQu9fXghKf2k';
  useEffect(() => {
    ...
    >
      ...
      <form id="myForm" ref={form} onSubmit={sendEmail}>
        ...
        <div className="relative z-0 w-full mb-8 group">
          ...
          <input readOnly className="invisible" type="text" class="form-control" name="subject" id="subject" placeholder="Subject" data-rule="minlen:4" value="New Email from Portfolio" data-msg="Please enter at least 8 chars of subject" required/>
        ...
        {isSubmit && 
          <div className="transition-all duration-300  ease-in-out inline-block rounded-lg  mt-3">
            <button disabled type="button" class="hover:bg-transparent transition ease-in duration-200 font-semibold cursor-pointer border-color-910   hover:border-transparent px-6  py-2 rounded-lg border-[2px]  hover:text-white   dark:text-white ">
